...
class OrderDetailsComplete extends StatefulWidget {
  final PartnerModel partnerModel;
  final JunkSalesModel junkSales;
  OrderDetailsComplete({this.partnerModel, this.junkSales});
  @override
  _OrderDetailsCompleteState createState() => _OrderDetailsCompleteState();
}

class _OrderDetailsCompleteState extends State<OrderDetailsComplete> {
