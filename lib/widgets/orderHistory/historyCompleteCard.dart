...
import 'package:lingkung_partner/screens/orderHistory/orderHistoryDetails/historyDetailsComplete.dart';
import 'package:lingkung_partner/utilities/colorStyle.dart';
import 'package:lingkung_partner/utilities/textStyle.dart';
import 'package:intl/intl.dart';

class HistoryCompleteCard extends StatefulWidget {
  final PartnerModel partnerModel;
  final JunkSalesModel junkSales;
  HistoryCompleteCard({this.junkSales, this.partnerModel});
  @override
  _HistoryCompleteCardState createState() => _HistoryCompleteCardState();
}

class _HistoryCompleteCardState extends State<HistoryCompleteCard> {
  @override
      ...
      child: ListTile(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => HistoryDetailsComplete(
